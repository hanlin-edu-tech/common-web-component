...
let ajaxUtil = (o, t, e) => ("GET" !== o && e && (e = JSON.stringify(e)), jQueryNoConflict.ajax({ type: o, cache: !1, crossDomain: !0, url: t, data: e, contentType: "application/json; charset=UTF-8", dataType: "json" })); let logout = () => {
...
let marqueeTarget = jQueryNoConflict("#ehanlin-header div.marquee"); let marqueeCloseTarget = jQueryNoConflict("#ehanlin-header i.marquee-close"); let isShowMarqueeClose = !0; let runMarquee = () => {
  jQueryNoConflict.ajax({ type: "get", url: "/Marquee", dataType: "json" }).then(e => {
    if (e && e.length > 0) {
      let r;marqueeTarget.removeAttr("style"), jQueryNoConflict.each(e, (e, o) => {
